...
class SnakesFactory:
    ...
    def getClusters(self,plot=False):
        ...
        allclusters_it3 = [X1[db.labels_ == i] for i in u[list(np.where(db.tag_[indices] == 3)[0])].tolist()]
        allclusters_it123 = allclusters_it1 + allclusters_it2 + allclusters_it3
        ...
        superclusters,superclusterContours = scAlgo.findSuperClusters(allclusters_it123,edges,image_fr_vignetted,image_fr_zs_vignetted,0)
