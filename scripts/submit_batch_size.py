#!/bin/env python
# USAGE: python3.8 scripts/submit_batch_size.py $PWD "[3792-3796]" --outdir cosmics_1stset_261120 --dry-run
...
if __name__ == "__main__":
    ...
    cmd = './../After_reco/davidesize.exe ../reco_runs/reco_run{r}-{rend}.root'.format(r=run,rend=runend)
    tmp_filecont = tmp_filecont.replace('RECOSTRING',cmd)
    tmp_filecont = tmp_filecont.replace('CYGNOBASE',abswpath+'/Size_analyzed/')
