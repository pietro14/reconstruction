        ...
        for line in open(samples,'r'):
           ...
           ## If we have a user-defined list of processes as signal
            ...
            for cname in cnames:
                ...
                tty = TreeToYield(rootfile, options, settings=extra, name=pname, cname=cname, objname=objname, variation_inputs=list(variations.values())); ttys.append(tty)
                if signal: 
...
def addMCAnalysisOptions(parser,addTreeToYieldOnesToo=True):
    ...
    parser.add_option("-t", "--tree",          dest="tree", default='nanogen', help="Pattern for tree name");
